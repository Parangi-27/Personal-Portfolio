...
function About() {
  ...
  return (
    <>
      <div
        className="section bg-black -my-10 lg:-my-24 transform skew-y-3 w-full"
        id="about"
      >
          ...
          <div className="text py-16 px-20 items-center">
            ...
            <div className="flex flex-col gap-y-6 lg:-mt-20 lg:flex-row">
              ...
              <div className="flex-1 text-white text-[36px] py-20 lg:text-[60px] font-secondary font-semibold  leading-[1]">
                ...
                >
                  <p className="max-w-2xl lg:text-lg mx-auto font-hairline py-5 lg:mt-12 -mt-20 leading-8">
                    I generally find enjoyment in taking complicated logics and
                    combining them with attractive straightforward UI designs. I
                    enjoy employing logic to create beautiful and effective code
                    in any well-known programming language.
                    <br /><br />
                    Fun Fact: I always love to playing with colors because
                    Painting is my one of the hobby. Hence, I will never
                    disappoint you in terms of my designs!
                  </p><br/><br/>
                  {/* <button
                      to="#"
